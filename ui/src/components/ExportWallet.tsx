  ...
  return (
    <div className="export-container">
      ...
      <div className="select-section-container">
        <div className="select-section wallet-select-section">
          ...
          <select
            ...
            onChange={(e) =>
              setSelectedWallet(
                wallets.find((x: any) => x.walletId === e.target.value),
              )
            }
          >
          ...
          <select
            ...
            onChange={(e) =>
              setSelectedWalletAccount(
                walletAccounts.find((x: any) => x.address === e.target.value),
              )
            }
          >
      ...
      <div className="action-buttons">
        <div className="action-button primary" onClick={exportWallet}>
          <p className="action-button-text">Export Wallet Seed</p>
        </div>

        <div className="action-button primary" onClick={exportWalletAccount}>
          <p className="action-button-text">Export Account Private Key</p>
        </div>

        <div className="action-button secondary" onClick={onCancel}>
